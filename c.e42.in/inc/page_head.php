...
<div id="page-wrapper"<?php if ($template['page_preloader']) { echo ' class="page-loading"'; } ?>>
    ...
    <div class="preloader themed-background">
        <h1 class="push-top-bottom text-light text-center"><strong>NFC</strong></h1>
        <div class="inner">
    ...
    <div id="page-container"<?php if ($page_classes) { echo ' class="' . $page_classes . '"'; } ?>>
        ...
        <div id="sidebar">
            ...
            <div id="sidebar-scroll">
                ...
                <div class="sidebar-content">
                    <!-- Brand -->
                    <a style="background-color:#A51C30;height:70px;" href="<?php echo BASEURL; ?>index.php" class="sidebar-brand">
                        <img width="100%" src="<?php echo BASEURL; ?>uploads/images/e42-logo.png">
                    </a>
                    <!-- END Brand -->
                    ...
                    <div class="sidebar-section sidebar-user clearfix sidebar-nav-mini-hide">
                        <div class="sidebar-user-avatar">
                            <a href="#">
                                <img src="<?php echo BASEURL; ?>img/nfc/no_image.jpg" alt="avatar">
                            </a>
                        </div>
                        <div class="sidebar-user-name"><?php echo $_SESSION['name']; ?></div>
                        <div class="sidebar-user-links">
                            <a href="<?php echo BASEURL.'myprofile'; ?>" data-toggle="tooltip" data-placement="bottom" title="Profile"><i class="gi gi-user"></i></a>
                            <a href="#" data-toggle="modal" class="enable-tooltip" data-placement="bottom" title="Settings"><i class="gi gi-cogwheel"></i></a>
                            <a href="<?php echo BASEURL.'logout'; ?>" data-toggle="tooltip" data-placement="bottom" title="Logout"><i class="gi gi-exit"></i></a>
                        </div>
                    </div>
                    <!-- END User Info -->
                    ...
                    <ul class="sidebar-nav">
                        <?php foreach( $primary_nav as $key => $link ) {
							...
							if ( (!isset($_SESSION['org_id']) || !$_SESSION['org_id']) && 
								 ($link['name'] == 'Wallet' ||
							...
							if ( !is_superuser() && $link['name'] == 'Organization' ) $link['url']=BASEURL.'org/modify/'.$_SESSION['org_id'];
        ...
        <div id="main-container">
            ...
            -->
            <header style="background-color:#A51C30;height:70px;" class="navbar<?php if ($template['header_navbar']) { echo ' ' . $template['header_navbar']; } ?><?php if ($template['header']) { echo ' '. $template['header']; } ?>">
                ...
                <!-- Search Form 
                <div id="nfc-search-bar" class="navbar-form-custom nfc-form-custom" role="search">
                    <div class="form-group">
                        <input type="text" id="top-search" name="nfc_tag_id" class="form-control" placeholder="Search by Roll Number">
                    </div> 
                </div> -->
                <!-- END Search Form -->
                ...
                <ul class="nav navbar-nav-custom pull-right">
                    ...
                    <li class="dropdown">
                        <a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="<?php echo BASEURL; ?>img/nfc/no_image.jpg" alt="avatar"> <i class="fa fa-angle-down"></i>
                        </a>
                        <ul class="dropdown-menu dropdown-custom dropdown-menu-right">
                            <li class="dropdown-header text-center">Account</li>
                            <li>
                                <a href="<?php echo BASEURL.'myprofile'; ?>">
                            ...
                            <li>
                                ...
                                <a href="<?php echo BASEURL.'logout'; ?>"><i class="fa fa-ban fa-fw pull-right"></i> Logout</a>
                            </li>
                        </ul>
                    </li>
                    <!-- END User Dropdown -->
