...
y(pi,Q);function qi(a,b){Q.call(this,1,arguments);this.b=a;this.isEnabled=b}
...
window.__onGCastApiAvailable=c;Cj("//www.gstatic.com/cast/sdk/libs/sender/0.0.1/cast_framework.js",Bj,c)}}
...
Ob:function(){S(Ei,f)}})}
function Vp(a,b,c,d){if(null!==b||null!==c){var e={};a&&(e.channel_id=a);null===b||(e.receive_all_updates=b);null===c||(e.receive_no_updates=c);Md("/subscription_ajax?action_update_subscription_preferences=1",{method:"POST",V:e,onError:function(){d&&d()}})}}
