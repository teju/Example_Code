...
public class MainActivity extends Activity implements OnClickListener {
									...
									new GraphUserCallback() {
										...
										public void onCompleted(
											...
											if (user != null) {
												...
												System.out.println("getUserInfoFromFacebook "+user.toString()+" "+response.getRequest().toString());
											}
										}
									}).executeAsync();
						}
	...
	private void getUserInfoFromFacebook(final GraphUser user) {
		...
		userHashmap.put(USER_NAME, user.getFirstName());

		System.out.println("PrinTINGINFORMAION "+user.getId()+" "+user.getId()+" "
				+user.getFirstName()+" "+ user.getLastName()+" "+user.getBirthday()+" "
				+(String) user.getProperty("name")+" "+user.getLocation());
