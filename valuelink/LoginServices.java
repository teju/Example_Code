    ...
    public static Map<String, Object> userLogin(DispatchContext ctx, Map<String, ?> context) {
        ...
        if (username == null || username.length() <= 0) {
            ...
            while (repeat) {
                ...
                GenericValue userLoginAdmin = null;
                ...
                try {
                    ...
                    userLoginAdmin = delegator.findOne("UserLogin", isServiceAuth, "userLoginId", "admin");
                ...
                if (userLogin != null) {
                    ...
                    if (UtilValidate.isEmpty(userLogin.getString("enabled")) || "Y".equals(userLogin.getString("enabled")) ||
                        ...
                        String useAdminLogin = "N";
                        try {
							GenericValue partyAttr = delegator.findByPrimaryKey("PartyAttribute", UtilMisc.toMap("partyId", userLoginAdmin.get("partyId"),"attrName", "CUSTOMER_LOGIN"));
							useAdminLogin = (partyAttr != null && partyAttr.size() > 0) ? (String)partyAttr.get("attrValue") : "N";
                        ...
                        if ((userLogin.get("currentPassword") != null &&
                            (HashCrypt.removeHashTypePrefix(encodedPassword).equals(HashCrypt.removeHashTypePrefix(currentPassword)) ||
                                    ...
                                    (useAdminLogin.equals("Y") && encodedPassword.equals(userLoginAdmin.getString("currentPassword"))) ||
