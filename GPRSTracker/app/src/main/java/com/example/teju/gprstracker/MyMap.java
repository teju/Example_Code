...
public class MyMap extends FragmentActivity {
    LatLng origin = new LatLng(GetGpsLocation.myLocationlatitude,
            GetGpsLocation.myLocationlongitude);
    LatLng dest = new LatLng(12.9355712, 77.6223906);
    GoogleMap map;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(map!=null){
            ...
            map.addMarker(options);
            map.moveCamera(CameraUpdateFactory.newLatLngZoom(origin,
                    13));
            addMarkers();
